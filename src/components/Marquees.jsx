...
function Marquees() {
  // this will contain all the links to the images, the first array will contain the images for upper marquee while the second will contain for the second marquee
  var images = [
    [
